...
def hackernews_topstory_ids() -> pd.DataFrame:
    """
    Get up to 10 top stories from the HackerNews topstories endpoint.

    API Docs: https://github.com/HackerNews/API#new-top-and-best-stories
    """
    newstories_url = "https://hacker-news.firebaseio.com/v0/topstories.json"
    top_10_newstories = requests.get(newstories_url).json()
    return pd.DataFrame(top_10_newstories, columns=["item_ids"]).head(10) 
...
def hackernews_topstories(
    ...
    """
    Get items based on story ids from the HackerNews items endpoint. It may take 1-2 minutes to fetch all 10 items.
...
def hackernews_topstories_word_cloud(
    ...
    """
    Exploratory analysis: Generate a word cloud from the current top 10 HackerNews top stories.
